                                    ...
                                    <div class="card-body">
                                        <form action="login_process.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputToken" name="token" type="text" placeholder="Enter token" />
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="adminRadio" name="role" class="custom-control-input" value="admin">
                                                    <label class="custom-control-label" for="adminRadio">Admin</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="userRadio" name="role" class="custom-control-input" value="user" checked>
